...
# RESTORE OPTIONS
restore_model              = 0                                               # Restore from saved model
restore_em                 = 0                                               # Restore experience memory from saved file
path_to_model_to_restore   = "./final_models/3_DIS_FINAL.ckpt-30"           # Path to the saved model
path_to_results_to_restore = "./final_results/3_RESULTS_DIS_FINAL.pkl"       # Path to file containing results to restore


# SAVE OPTIONS
save_model_frequency    = 10                                                 # Frequency of saving models (in episodes)
max_to_keep             = 50                                                 # Maximum number of models to keep saved
path_to_model_to_save   = "./final_models/3_DIS_FINAL.ckpt"                  # Path to save the model
path_to_results_to_save = "./final_results/3_RESULTS_DIS_FINAL.pkl"          # Path to save the results
save_offset             = 0                                                        
...
learning_rate           = 0.001             # Learning rate for training the neural network

# STAGE OPTIONS
num_agents       = 3              # Number of agents in the environment
num_episodes     = 100            # Number of episodes
max_discrepancy  = 200            # Maximum discrepancy per agent
min_discrepancy  = 1              # Minimum discrepancy per agent
task             = 0              # 0: dispersion, 1: square formation, 2: aggregation, 3: chain formation
steps_limit      = 300            # Limit of steps per episode
desired_distance = 0.35           # Side of squares in square formation task, 
                                  # or maximum distance to nearest partnet in dispersion task

# REPLAY MEMORY OPTIONS            
em_capacity   = 500000                                   # Initial capacity of the experience memory
...
# EXPLORATIN EXPLOITATION OPTIONS
initial_b_temperature = 4    #  Initial boltzmann temperature
...
# Use search to reduce learning time
use_search = 0
search_frequency = 1
